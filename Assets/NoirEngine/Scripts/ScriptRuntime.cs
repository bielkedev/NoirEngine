...
namespace Noir.Script
{
	public class ScriptRuntime
	{
		...
		/// </summary>
		private static bool bSuspendScript;
		/// <summary>
		...
		public static void runScript()
		{
			...
			for (; ScriptRuntime.nCurrentLineIndex < ScriptRuntime.sCurrentScript.ScriptLineList.Count; ++ScriptRuntime.nCurrentLineIndex)
			{
